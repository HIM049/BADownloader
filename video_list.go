...
// 创建文件并保存
func MakeAndSaveList(filePath, favlistID string, downloadCount int, downloadCompilation bool) error {
	data, err := MakeVideoList(favlistID, downloadCount, downloadCompilation)
	if err != nil {
		return err
	}
...
// 创建视频任务列表
func MakeVideoList(favlistID string, downloadCount int, downloadCompilation bool) (*[]VideoInformationList, error) {
